...
$XGETTEXT $(find . -name \*.cpp -o -name \*.h) -o "$podir"/kde-inotify-survey.pot
...
$XGETTEXT --join-existing --language=JavaScript $(find . -name \*.qml -o -name \*.js) -o "$podir"/kde-inotify-survey.pot
